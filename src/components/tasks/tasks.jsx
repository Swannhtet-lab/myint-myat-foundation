    ...
    <section id="tasks" className="tasks-section">
      ...
      <div className="tasks-grid"></div>git push -u origin ruparnwe
        ...
        <div className="task-card">
          ...
          <p>တက္ကသိုလ်အဆင့် ကျောင်းသား/ကျောင်းသူများအား ပညာသင်ဆုများ ပေးအပ်လျက်ရှိရာ ၂၀၁၆ မှ ၂၀၂၅ အထိ တက္ကသိုလ် ကျောင်းသား/သူ (၉၈) ဉီးကို ပညာသင်ဆုများပေးအပ်နိုင်ခဲ့ပြီး ဘွဲ့ရရှိသူ (၂၇) ဉီးပေါ်ထွန်းလာပြီဖြစ်ပါသည်။</p>
          <a href="#" className="task-link">ပုံကြည့်ရန်</a>
      </div>
      <div className="tasks-grid"></div>
        <div className="task-card">
          ...
          <p>ကျောင်းသား/သူများ ပညာသင်ကြားရေးတွင် အထောက်အကူပြုနိုင်ရန်နှင့် အသိဉာဏ်ဖွံဖြိုးတိုးတက်စေရန် ရည်ရွယ်၍ အများပြည်သူဖတ်ရှုလေ့လာနိုင်မည့် စာကြည့်တိုက်တစ်ခုကို ၂၀၂၀ ခုနှစ်တွင် တည်ထောင်ဖွင့်လှစ်ထားရှိပါသည်။</p>
          <a href="#" className="task-link">ပုံကြည့်ရန်</a>
      </div>
    </div>  
    </section>
